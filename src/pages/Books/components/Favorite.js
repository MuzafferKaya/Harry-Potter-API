...
import {
  addBookFavorite,
  removeBookFavorite,
} from "../../../store/bookFavoriterSlice";
import { useDispatch, useSelector } from "react-redux";
import { toast } from "react-toastify";

function Favorite({ data }) {
  const favorites = useSelector((state) => state.bookFavoriterStore.books);
  ...
  function favoriteClickHandler() {
    if (isFavorite) {
      setIsFavorite(false);
      dispatch(removeBookFavorite(data));
